...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
  <div class="container flex flex-wrap items-center justify-between mx-auto">
    <a href="http://localhost:5173/" class="flex items-center">
        <img src="https://w7.pngwing.com/pngs/688/689/png-transparent-pogchamp-emote-memes-mixed-memes.png" class="h-6 mr-3 sm:h-9" alt="Pog" />
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Fett digitalt library</span>
    </a>
